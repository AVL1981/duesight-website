...
def _render_pipeline_section(target: TargetConfig, manifest: dict[str, Any], report: dict[str, Any]) -> str:
    ...
    return f"""
        <div class="section pipeline-certification" id="pipeline-certification" data-run-id="{_html(manifest['run_id'], 120)}">
            ...
            <div class="pipeline-artifact-links" aria-label="Pipeline artifacts">
                <a href="pipeline-manifest.json">Manifest JSON</a>
                <a href="pipeline-score.json">Pipeline score JSON</a>
                <a href="evidence-ledger.json">Evidence ledger JSON</a>
                <a href="pipeline-evidence.json">Normalized report JSON</a>
            </div>
